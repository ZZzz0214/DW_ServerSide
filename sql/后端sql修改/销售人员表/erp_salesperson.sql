...
-- ----------------------------
-- Table structure for erp_salesperson
-- ----------------------------
DROP TABLE IF EXISTS `erp_salesperson`;
CREATE TABLE `erp_salesperson`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '销售人员表编号（主键，自增）',
  `salesperson_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '销售人员姓名',
