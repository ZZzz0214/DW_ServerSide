...
CREATE TABLE `erp_purchase_order`  (
  ...
  `shipping_fee` decimal(24, 6) NULL DEFAULT NULL COMMENT '采购运费（合计）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 采购订单表' ROW_FORMAT = DYNAMIC;
