...
CREATE TABLE `erp_purchase_order_items`  (
  ...
  `purchase_price` decimal(24, 6) NULL DEFAULT NULL COMMENT '采购单价',
  `shipping_fee` decimal(24, 6) NULL DEFAULT NULL COMMENT '采购运费',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 采购订单项表' ROW_FORMAT = DYNAMIC;
