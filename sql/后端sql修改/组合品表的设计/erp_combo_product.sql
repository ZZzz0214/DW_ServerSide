...
CREATE TABLE `erp_combo_product`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '组品id（主键，自增）',
  ...
  `total_quantity` int(11) NULL DEFAULT NULL COMMENT '产品数量',
  ...
  `status` tinyint(4) NOT NULL COMMENT '组品状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '组合产品表' ROW_FORMAT = DYNAMIC;
