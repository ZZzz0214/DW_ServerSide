...
-- ----------------------------
-- Table structure for erp_group_buying_info
-- ----------------------------
DROP TABLE IF EXISTS `erp_group_buying_info`;
CREATE TABLE `erp_group_buying_info`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '团购信息编号',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 团购信息表' ROW_FORMAT = DYNAMIC;
