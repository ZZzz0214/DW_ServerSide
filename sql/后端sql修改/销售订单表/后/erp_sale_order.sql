...
CREATE TABLE `erp_sale_order`  (
  ...
  `total_shipping_fee` decimal(24, 6) NULL DEFAULT 0.000000 COMMENT '出货运费合计',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 销售订单表' ROW_FORMAT = DYNAMIC;
