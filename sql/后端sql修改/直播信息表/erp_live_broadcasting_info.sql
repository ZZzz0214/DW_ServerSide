...
-- ----------------------------
-- Table structure for erp_live_broadcasting_info
-- ----------------------------
DROP TABLE IF EXISTS `erp_live_broadcasting_info`;
CREATE TABLE `erp_live_broadcasting_info`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '直播信息编号',
