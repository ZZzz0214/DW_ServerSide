...
-- ----------------------------
DROP TABLE IF EXISTS `erp_live_broadcasting`;
CREATE TABLE `erp_live_broadcasting`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '直播货盘编号',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'ERP 直播货盘表' ROW_FORMAT = DYNAMIC;
