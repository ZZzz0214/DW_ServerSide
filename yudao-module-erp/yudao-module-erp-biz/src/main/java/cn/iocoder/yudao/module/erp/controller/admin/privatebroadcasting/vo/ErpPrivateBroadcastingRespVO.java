...
@Schema(description = "管理后台 - ERP 私播货盘 Response VO")
@Data
@ExcelIgnoreUnannotated
public class ErpPrivateBroadcastingRespVO {

    @Schema(description = "私播货盘编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
