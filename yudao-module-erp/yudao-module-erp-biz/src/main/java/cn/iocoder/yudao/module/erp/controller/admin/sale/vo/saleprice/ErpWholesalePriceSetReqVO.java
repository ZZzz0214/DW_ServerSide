...
@Schema(description = "管理后台 - 批发价格设置 Request VO")
@Data
public class ErpWholesalePriceSetReqVO {
    ...
    @Schema(description = "批发单价", requiredMode = Schema.RequiredMode.REQUIRED, example = "100.00")
