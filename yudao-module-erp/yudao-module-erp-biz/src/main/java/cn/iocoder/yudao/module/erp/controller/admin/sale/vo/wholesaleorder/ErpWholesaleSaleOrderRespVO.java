...
@Schema(description = "管理后台 - ERP 批发销售订单 Response VO")
@Data
@ExcelIgnoreUnannotated
public class ErpWholesaleSaleOrderRespVO {

    @Schema(description = "编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "17386")
    @ExcelProperty("编号")
    private Long id;

    @Schema(description = "批发销售单编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "XS001")
    @ExcelProperty("批发销售单编号")
    private String no;
    ...
    @Schema(description = "物流费用合计", requiredMode = Schema.RequiredMode.REQUIRED, example = "100.00")
    ...
    @Schema(description = "货拉拉费用合计", requiredMode = Schema.RequiredMode.REQUIRED, example = "100.00")
