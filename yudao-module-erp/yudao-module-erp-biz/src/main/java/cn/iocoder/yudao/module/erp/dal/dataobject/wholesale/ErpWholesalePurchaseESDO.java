...
@Data
@Document(indexName = "erp_wholesale_purchase")
public class ErpWholesalePurchaseESDO {
    ...
    @Field(name = "truck_fee", type = FieldType.Double)
    private BigDecimal truckFee;

    @Field(name = "logistics_fee", type = FieldType.Double)
